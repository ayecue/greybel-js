...
function readVarLines(varLines: string[], map: { [key: string]: string }): { [key: string]: string } {
	if (map == null) map = {};
...
function loadConfigFile(filepath: string, map: { [key: string]: string }): { [key: string]: string } {
